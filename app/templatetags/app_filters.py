...
from app.models import Action, Account, Statistics
from app.views import sanitize_js
...
def isDateable(field):
    return isinstance(field.field, forms.DateField) or isinstance(field.field,
                                                                  forms.DateTimeField) or isinstance(
