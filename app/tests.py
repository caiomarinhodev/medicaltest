...
from app.forms import ProfileForm, validate_birthday, \
    validate_username_available, validate_username_exists
from app.models import Hospital
from app.models import Location
from app.models import Profile, User
from app.views_home import *
...
class InvalidUser(TestCase):
    ...
    def test_invalidUser(self):
        ...
        self.assertRedirects(response, '/setup/', status_code=302, target_status_code=200,
                             msg_prefix='')
...
class TestFormValidators(TestCase):
    ...
    def test_validate_username_exists(self):
        ...
        self.assertRaises(forms.ValidationError, validate_username_exists,
